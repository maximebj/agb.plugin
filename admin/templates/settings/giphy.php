...
<div class="AGB-form__setting">
  ...
  <div class="AGB-form__field">
    <?php if( current_user_can( 'manage_options' ) ): ?>
      <input type="text" name="advanced-gutenberg-blocks-giphy-api-key" placeholder="<?php _e( 'Insert your Giphy API Key here', 'advanced-gutenberg-blocks' ); ?>" value="<?php echo esc_attr( get_option( 'advanced-gutenberg-blocks-giphy-api-key' ) ); ?>">
    <?php else: ?>
