<div class="AGB-form__setting">
  ...
  <div class="AGB-form__field">
    <?php if( current_user_can( 'manage_options' ) ): ?>
      <input type="text" name="advanced-gutenberg-blocks-opengraph-api-key" placeholder="<?php _e( 'Insert your OpenGraph.io API Key here', 'advanced-gutenberg-blocks' ); ?>" value="<?php echo get_option( 'advanced-gutenberg-blocks-opengraph-api-key' ); ?>">
    <?php else: ?>
