...
export default registerBlockType('advanced-gutenberg-blocks/summary', {
	title: __('Table of contents', 'advanced-gutenberg-blocks'),
	description: __(
		'Display an auto generated, dynamic table of contents',
		...
		return (
			<Fragment>
				...
				<div className="wp-block-advanced-gutenberg-blocks-summary">
					...
					/>
					<List
						{...{ ordered, setAttributes, blocks, updateBlockAttributes }}
					/>
				</div>
			</Fragment>
		)
	...
	save: props => {
		...
		return (
			<div>
				<p className="wp-block-advanced-gutenberg-blocks-summary__title">
					{title}
				</p>
