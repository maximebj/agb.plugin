...
export default registerBlockType("gutenblocks/gmap", {
	...
	edit: props => {
		...
		!props.attributes.longitude &&
			props.setAttributes({ longitude: 2.3522 })
				...
				{!props.attributes.address &&
					...
					typeof gutenblocksGmap == "undefined" && (
						<p class="gutenblocks-block-message">
							{__(
								"Type your address on the inspector",
								"advanced-gutenberg-blocks"
							)}
						</p>
					)}
