  ...
  render() {
    return (
      <div className="wp-block-advanced-gutenberg-blocks-plugin">
	        ...
	        <a href={this.props.attributes.downloadLink} className="wp-block-advanced-gutenberg-blocks-plugin__picture">
          ...
          <div className="wp-block-advanced-gutenberg-blocks-plugin__main">
            ...
            <p className="wp-block-advanced-gutenberg-blocks-plugin__desc">{this.props.attributes.description}</p>
				...
				<footer className="wp-block-advanced-gutenberg-blocks-plugin__footer">
					<div className="wp-block-advanced-gutenberg-blocks-plugin__meta">
						<p className="wp-block-advanced-gutenberg-blocks-plugin__rating">
							<span className="wp-block-advanced-gutenberg-blocks-plugin__stars" data-note={this.props.attributes.rating}>
								{this.state.stars}
							</span>
							&nbsp;
						...
						<p className="wp-block-advanced-gutenberg-blocks-plugin__active" data-installs={this.props.attributes.activeInstalls}>
